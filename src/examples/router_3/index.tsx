...
import { PermissionEnum } from "@/comps/rbac";
...
export function MenuParentPage() {
    return <div style={{ width: "100%", display: "flex", flexDirection: "row" }}>
        <div className="left">
            <MenuForRoute menus={menuRoutConfig} theme="dark" style={{ width: 300 }} mode="inline" />
        </div>
...
const menuRoutConfig: IMenuRouteElementProps[] = [
    ...
    },
    {
        ...
        children: [
            {
                needPermission: PermissionEnum.PRIVATE_1,
                key: "目录2-1",
                title: "目录2-1（需要权限:1）",
                path: "/page2/Page2_1",
                component: Page2_1,
            },
            {
                ...
                path: "/page2/Page2_2",
                component: Page2_2,
                needPermission: PermissionEnum.PRIVATE_2,
            },
            {
                key: "目录2-3",
                title: "目录2-3",
